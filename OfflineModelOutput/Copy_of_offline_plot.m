close all;clear;clc;
% off_data=zeros(4);
off_data(1)=load('offline_-50_0.mat');
off_data(2)=load('offline_-50_0.785.mat');
off_data(3)=load('offline_-50_1.57.mat');
off_data(4)=load('offline_-50_3.14.mat');
dp_plot=figure();
title_char=["x","y","\psi"];
for j=1:4
    for i=1:3
...
suptitle("Setpoint Expriments (0, \pi/4, \pi/2 and \pi) Under 50% Current (-x Direction)");
% ax =subplot(3,2,2);
